...
Load at the **INTEGRATE phase** when preparing drift tests that guard a data analysis's key results before it is finished. `integration-workflow` Protect invokes this reference alongside the quality checklist.
