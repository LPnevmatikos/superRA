...
description: Utility (cross-cutting discipline). Use before claiming work is complete, fixed, passing, or ready to commit/PR — requires running verification commands and confirming actual output matches the claim. Evidence before assertions. Prevents "looks fine" from reaching merge.
---
