...
**Scope:** Cross-skill coherence across the 17-task refactor. Branch `refactor/workflow-domain-split`; git range `917e5f5..d351b86`. Plugin-dev vertical — `refactor-and-integrate/references/codebase-integration.md` (generic code-quality + §Project Doc Audit) was the operative reference.
